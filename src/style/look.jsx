...
const look = {
  ...
  ToggleBaseStyle: (value) => ({
    ...
    backgroundColor: value ? tone.adj : "#3A3A3C",
    position: "relative",
    cursor: "pointer",
  ...
  tgButton3: (col, boo) => ({
    ...
    pointerEvents: "none",
    // textDecoration: boo.isMoPsHd ? "underline" : "none", // ← 追加
  ...
  ac3: {
    ...
    display: "flex",
    position: "relative",
    backgroundColor: tone.acButtons,
  },
